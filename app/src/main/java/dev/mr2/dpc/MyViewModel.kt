...
import dev.mr2.dpc.Privilege.DAR
import dev.mr2.dpc.Privilege.DPM
import dev.mr2.dpc.dpm.ACTIVATE_DEVICE_OWNER_COMMAND
import dev.mr2.dpc.dpm.ApnAuthType
...
import dev.mr2.dpc.dpm.DelegatedAdmin
...
import dev.mr2.dpc.dpm.KeyguardDisableMode
import dev.mr2.dpc.dpm.NetworkStatsData
import dev.mr2.dpc.dpm.NetworkStatsTarget
import dev.mr2.dpc.dpm.PasswordComplexity
import dev.mr2.dpc.dpm.PendingSystemUpdateInfo
import dev.mr2.dpc.dpm.PreferentialNetworkServiceInfo
import dev.mr2.dpc.dpm.PrivateDnsConfiguration
import dev.mr2.dpc.dpm.PrivateDnsMode
import dev.mr2.dpc.dpm.ProxyMode
import dev.mr2.dpc.dpm.ProxyType
import dev.mr2.dpc.dpm.QueryNetworkStatsParams
import dev.mr2.dpc.dpm.RecommendedProxyConf
import dev.mr2.dpc.dpm.RpTokenState
import dev.mr2.dpc.dpm.SsidPolicy
...
class MyViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun uninstallPackage(packageName: String, onComplete: (String?) -> Unit) {
        val action = "dev.mr2.dpc.action.PACKAGE_UNINSTALLED"
    ...
    fun getDeviceAdminReceivers() {
        viewModelScope.launch(Dispatchers.IO) {
            deviceAdminReceivers.value = PM.queryBroadcastReceivers(
                ...
                it.isVisible && it.packageName != "dev.mr2.dpc" &&
