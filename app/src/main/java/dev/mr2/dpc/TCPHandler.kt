...
fun realHandler(context: Context, req: JSONObject): JSONObject {
    ...
    try {
        ret = when (act) {
            ...
            "SYSTEM_DISABLE_STATBAR" -> { requires(23); dpm.setStatusBarDisabled(receiver, true) }
            "SYSTEM_ENABLE_STATBAR" -> { requires(23); dpm.setStatusBarDisabled(receiver, false) }
            ...
            "SYSTEM_DISABLE_BT_SHARE" -> { requires(23); dpm.setBluetoothContactSharingDisabled(receiver, true) }
            "SYSTEM_ENABLE_BT_SHARE" -> { requires(23); dpm.setBluetoothContactSharingDisabled(receiver, false) }
            ...
            "SYSTEM_DISABLE_KEYGUARD" -> { requires(23); dpm.setKeyguardDisabled(receiver, true) }
            "SYSTEM_ENABLE_KEYGUARD" -> { requires(23); dpm.setKeyguardDisabled(receiver, false) }
            ...
            "APP_SET_PERMISSION_DEFAULT" -> { requires(23); dpm.setPermissionGrantState(receiver, getArg<String>("package", req), getArg<String>("permission", req), DevicePolicyManager.PERMISSION_GRANT_STATE_DEFAULT) }
            "APP_SET_PERMISSION_GRANTED" -> { requires(23); dpm.setPermissionGrantState(receiver, getArg<String>("package", req), getArg<String>("permission", req), DevicePolicyManager.PERMISSION_GRANT_STATE_GRANTED) }
            "APP_SET_PERMISSION_DENIED" -> { requires(23); dpm.setPermissionGrantState(receiver, getArg<String>("package", req), getArg<String>("permission", req), DevicePolicyManager.PERMISSION_GRANT_STATE_DENIED) }
            ...
            "GET_BLUETOOTH_CONTACT_SHARING_STATE" -> { requires(23); dpm.getBluetoothContactSharingDisabled(receiver) }
            ...
            "GET_PERMISSION_GRANT_STATE" -> { requires(23); dpm.getPermissionGrantState(receiver, getArg<String>("app", req), getArg<String>("permission", req)) }
            "GET_PERMISSION_POLICY" -> { requires(23); dpm.getPermissionPolicy(receiver) }
