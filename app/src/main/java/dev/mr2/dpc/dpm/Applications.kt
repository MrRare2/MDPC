...
import dev.mr2.dpc.AppInstallerActivity
...
import dev.mr2.dpc.parsePackageNames
...
fun ApplicationsFeaturesScreen(onNavigateUp: () -> Unit, onNavigate: (Any) -> Unit, onSwitchView: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            FunctionItem(R.string.permissions, icon = R.drawable.shield_fill0) { onNavigate(PermissionManager) }
