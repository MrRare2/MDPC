...
import dev.mr2.dpc.MyApplication
import dev.mr2.dpc.MyNotificationChannel
import dev.mr2.dpc.NotificationType
...
@SuppressLint("PrivateApi")
fun binderWrapperPackageInstaller(appContext: Context): PackageInstaller? {
    try {
        val context = appContext.createPackageContext(Dhizuku.getOwnerComponent().packageName, Context.CONTEXT_IGNORE_SECURITY)
