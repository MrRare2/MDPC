...
import dev.mr2.dpc.DHIZUKU_CLIENTS_FILE
import dev.mr2.dpc.DhizukuClientInfo
import dev.mr2.dpc.DhizukuPermissions
import dev.mr2.dpc.HorizontalPadding
import dev.mr2.dpc.IUserService
import dev.mr2.dpc.MyAdminComponent
import dev.mr2.dpc.Privilege
import dev.mr2.dpc.R
import dev.mr2.dpc.SP
import dev.mr2.dpc.Settings
import dev.mr2.dpc.showOperationResultToast
import dev.mr2.dpc.ui.CircularProgressDialog
import dev.mr2.dpc.ui.InfoItem
    ...
    Scaffold(
        ...
        Column(Modifier
            ...
            Column(Modifier.padding(HorizontalPadding, 20.dp)) {
                ...
                Text(stringResource(R.string.dpm_warning))
            }
        }
...
const val ACTIVATE_DEVICE_OWNER_COMMAND = "dpm set-device-owner dev.mr2.dpc/.Receiver"
